...
if old in s:
    ...
    raise SystemExit('name matching anchor missing')
old_target="  const target=resolveTarget()||document;"
new_target="  const target=document;"
if old_target in s:
